import type { SpecializationArea, IntibakMapping, ScheduleOffering } from '../types';
...
export const SPECIALIZATION_AREAS: SpecializationArea[] = [
    {
        id: 'electronics',
        name: 'Elektronik',
        nameEn: 'Electronics',
...
export const INTIBAK_MAPPINGS: IntibakMapping[] = [
...
export const SAMPLE_SCHEDULES: ScheduleOffering[] = [
