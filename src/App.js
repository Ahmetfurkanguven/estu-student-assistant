...
import { Upload, Calendar, CheckCircle, AlertCircle, Trash2, Github, Download, BarChart3, CheckCircle2, Calculator, Info, Award, ShieldCheck, Globe } from 'lucide-react';
 ...
 */
function parseTranscriptAdvanced(text) {
    const records = [];
...
export default function App() {
    ...
    const handleFileUpload = async (e) => {
        ...
        try {
            ...
            parsed = parsed.filter(r => r.courseCode !== 'MFALM102' &&
                r.courseCode !== 'TTTT02');
            setRecords(parsed);
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100", children: [_jsx("header", { className: "bg-white shadow-md", children: _jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex justify-between items-center", children: [_jsxs("div", { children: [_jsxs("h1", { className: "text-xl md:text-3xl font-bold text-indigo-900 leading-tight text-center md:text-left", children: [_jsx("span", { className: "md:hidden", children: t('header_title_mobile') }), _jsx("span", { className: "hidden md:block", children: t('header_title_desktop') })] }), _jsx("p", { className: "mt-2 text-gray-600 font-medium", children: t('header_subtitle') })] }), _jsxs("button", { onClick: () => setLanguage(l => l === 'tr' ? 'en' : 'tr'), className: "flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-100 hover:bg-gray-200 text-gray-700 font-medium transition-colors", children: [_jsx(Globe, { className: "w-4 h-4" }), _jsx("span", { children: language === 'tr' ? 'EN' : 'TR' })] })] }) }), _jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [_jsx("div", { className: "flex items-center justify-between mb-8 overflow-x-auto", children: [
                            ...
                            { num: 5, label: t('step_report'), icon: Download }
                                            ...
                                            generateAcademicReport({
                                                ...
                                                return (_jsxs("div", { children: [_jsxs("div", { className: "flex flex-col md:flex-row gap-6 mb-8", children: [_jsxs("div", { className: `flex-1 p-4 rounded-xl border-l-4 ${isTotalMet ? 'bg-green-50 border-green-500' : 'bg-amber-50 border-amber-500'} shadow-sm`, children: [_jsx("h3", { className: "font-bold text-gray-800 mb-1", children: t('total_tech_electives') }), _jsxs("div", { className: "flex items-end gap-2", children: [_jsx("span", { className: "text-3xl font-bold", children: analysis.totalTechnicalElectives }), _jsx("span", { className: "text-gray-500 mb-1", children: t('min_7_courses') })] }), _jsx("p", { className: `text-sm mt-2 ${isTotalMet ? 'text-green-700' : 'text-amber-700'}`, children: isTotalMet ? t('total_courses_met_msg') : t('min_7_courses_warning') })] }), _jsxs("div", { className: "flex-1 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-xl shadow-sm", children: [_jsx("h3", { className: "font-bold text-gray-800 mb-1", children: t('best_group_title') }), _jsx("div", { className: "text-xl font-bold text-blue-900", children: analysis.bestGroup
                                                            ...
                                                            return (_jsxs("div", { className: "bg-white p-4 rounded-lg shadow-sm border border-indigo-100", children: [_jsxs("div", { className: "flex justify-between items-center mb-3 pb-2 border-b border-gray-100", children: [_jsx("div", { className: "font-bold text-gray-800 text-lg", children: code }), _jsxs("div", { className: "flex gap-1", children: [lectures.length > 0 && (_jsxs("span", { className: "text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded", children: [lectures.length, " ", t('lecture')] })), labs.length > 0 && (_jsxs("span", { className: "text-xs bg-orange-100 text-orange-700 px-2 py-1 rounded", children: [labs.length, " ", t('lab')] }))] })] }), lectures.length > 0 && (_jsxs("div", { className: "mb-3", children: [_jsxs("div", { className: "flex justify-between items-center mb-2", children: [_jsx("div", { className: "text-xs font-semibold text-blue-700 flex items-center gap-1", children: "\uD83D\uDCD6 Teorik Ders" }), _jsxs("button", { onClick: () => {
                                                                        ...
                                                                        return (_jsxs("div", { children: [_jsxs("div", { className: "text-xs font-semibold text-orange-700 mb-2 flex items-center gap-1", children: ["\uD83D\uDD2C Laboratuvar Gruplar\u0131", selectedLabSection && (_jsxs("span", { className: "ml-2 px-2 py-0.5 bg-green-100 text-green-700 rounded", children: ["\u2713 ", t('group'), " ", selectedLabSection, " ", t('selected_suffix') || 'seçildi'] }))] }), _jsx("div", { className: "space-y-2", children: Array.from(new Set(labs.map(l => l.section))).sort().map(section => {
                                                                            ...
                                                                            })] }, timeSlot))) })] }) }), _jsxs("div", { className: "mt-6", children: [_jsx("h3", { className: "font-semibold text-gray-900 mb-3", children: t('conflict_analysis_title') }), (() => {
                                                                const conflicts = detectScheduleConflicts(selectedSchedule);
                                                                return conflicts.length > 0 ? (_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: conflicts.map((c, i) => (_jsxs("div", { className: "p-3 bg-red-50 border border-red-200 rounded-lg flex items-start", children: [_jsx(AlertCircle, { className: "text-red-500 mt-0.5 mr-2 shrink-0", size: 18 }), _jsxs("div", { children: [_jsx("div", { className: "font-bold text-red-900 text-sm", children: t('conflict_detected') }), _jsx("div", { className: "text-red-700 text-sm mt-1", children: c.courses.join(' ve ') }), _jsx("div", { className: "text-red-600 text-xs mt-0.5", children: c.time })] })] }, i))) })) : (_jsx("div", { className: "p-4 bg-green-50 border border-green-200 rounded-lg", children: _jsxs("p", { className: "text-sm text-green-800 flex items-center", children: [_jsx(CheckCircle, { className: "mr-2", size: 16 }), t('conflict_success')] }) }));
                                                            })()] })] }))] }), _jsxs("div", { className: "flex justify-between items-center", children: [_jsx("button", { onClick: () => setStep(3), className: "px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50", children: t('btn_back') }), _jsxs("div", { className: "flex gap-3", children: [_jsx("button", { onClick: () => setStep(5), className: "px-6 py-2 border border-gray-300 text-gray-600 rounded-lg hover:bg-gray-50", children: t('btn_skip') }), _jsx("button", { onClick: () => setStep(5), className: "px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700", children: t('download_report') })] })] })] })), step === 5 && gpa && (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "bg-white rounded-xl shadow-lg p-8", children: [_jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-6", children: t('report_title') }), _jsxs("div", { className: "space-y-4 mb-6", children: [_jsxs("div", { className: "p-4 bg-gray-50 rounded-lg", children: [_jsx("h3", { className: "font-semibold mb-2", children: t('grade_status_title') }), _jsxs("p", { children: [t('gno_caps') || 'GNO', ": ", _jsx("strong", { children: gpa.gno.toFixed(2) }), " | ", t('ects_caps') || 'AKTS', ": ", _jsxs("strong", { children: [gpa.totalECTS, "/240"] })] })] }), selectedArea && (_jsxs("div", { className: "p-4 bg-gray-50 rounded-lg", children: [_jsx("h3", { className: "font-semibold mb-2", children: t('best_spec_title') }), _jsx("p", { children: (() => {
                                                                    const analysis = analyzeSpecializations(records);
                                                                    ...
                                                                    if (best) {
                                                                        ...
                                                                        return (_jsxs(_Fragment, { children: [_jsx("strong", { children: best.name }), _jsxs("p", { className: "text-sm text-gray-600 mt-1", children: [t('progress_label'), " ", groupResult?.takenCount, "/5 ", t('courses_lower') || 'ders'] })] }));
                                                                    }
                                                                    return _jsx("span", { children: t('no_data_yet') });
                                                                })() })] })), eem413Check && (_jsxs("div", { className: "p-4 bg-gray-50 rounded-lg", children: [_jsx("h3", { className: "font-semibold mb-2", children: t('eem413_title') }), _jsx("p", { className: eem413Check.eligible ? 'text-green-600' : 'text-red-600', children: eem413Check.eligible ? t('can_take_short') : t('cannot_take_short') })] }))] }), _jsxs("div", { className: "space-y-4", children: [_jsxs("button", { onClick: () => {
                                                            const passedCodes = new Set(records.filter(r => r.grade.passed).map(r => r.courseCode));
                                                            const simResult = simulationRecords.length > 0 ? calculateGPA(simulationRecords) : null;
                                                            generateAcademicReport({
                                                                studentName: 'Öğrenci',
                                                        ...
                                                        }, className: "w-full flex items-center justify-center px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors shadow-lg transform hover:scale-[1.02]", children: [_jsx(Download, { size: 24, className: "mr-2" }), _jsx("span", { className: "font-bold text-lg", children: t('download_pdf_report') })] }), _jsx("p", { className: "text-center text-sm text-gray-500 mt-4", children: t('report_footer_info') })] })] }), _jsxs("div", { className: "flex justify-between", children: [_jsx("button", { onClick: () => setStep(4), className: "px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50", children: t('btn_back') }), _jsx("button", { onClick: () => setStep(1), className: "px-6 py-2 border border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50", children: t('btn_new_analysis') })] })] })), ")"] })
                        ,
                            _jsx("footer", { className: "bg-white border-t mt-12", children: _jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6", children: [_jsxs("p", { className: "text-center text-gray-600 text-sm font-medium", children: [_jsx("span", { className: "md:hidden", children: t('footer_title_mobile') }), _jsx("span", { className: "hidden md:block", children: t('footer_title_desktop') })] }), _jsxs("div", { className: "flex flex-col items-center gap-3 mt-4", children: [_jsxs("div", { className: "flex items-center gap-2 text-xs text-emerald-700 bg-emerald-50 px-4 py-2 rounded-full border border-emerald-100 shadow-sm", children: [_jsx(ShieldCheck, { size: 16 }), _jsx("span", { className: "font-medium", children: t('footer_security') })] }), _jsxs("div", { className: "flex items-center gap-3 text-xs text-gray-400", children: [_jsx("span", { children: t('footer_author') }), _jsx("span", { className: "text-gray-300", children: "|" }), _jsxs("a", { href: "https://github.com/", target: "_blank", rel: "noreferrer", className: "flex items-center gap-1 text-indigo-500 hover:text-indigo-700 transition-colors font-medium", children: [_jsx(Github, { size: 14 }), _jsx("span", { children: t('footer_opensource') })] })] })] })] }) })
                                ,
                                    _jsx(VisitorCounter, {}))] }), "); }"] }));
}
