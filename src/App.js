...
import { Upload, Calendar, CheckCircle, AlertCircle, Trash2, Github, Download, BarChart3, CheckCircle2, Calculator, Info, Award, ShieldCheck, Languages } from 'lucide-react';
...
function compareSemesters(sem1, sem2) {
    ...
    if (!match1 || !match2)
        return sem1.localeCompare(sem2);
 ...
 */
function checkEEM413Eligibility(records, gpa, t) {
    const reasons = [];
    if (gpa.gno < 2.0) {
...
export default function App() {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100", children: [_jsx("header", { className: "bg-white shadow-md", children: _jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row md:items-center justify-between gap-4", children: [_jsxs("div", { children: [_jsxs("h1", { className: "text-xl md:text-3xl font-bold text-indigo-900 leading-tight text-center md:text-left", children: [_jsx("span", { className: "md:hidden", children: t('header_title_mobile') }), _jsx("span", { className: "hidden md:block", children: t('header_title_desktop') })] }), _jsx("p", { className: "mt-2 text-gray-600 font-medium text-center md:text-left", children: t('header_subtitle') })] }), _jsxs("button", { onClick: () => setLang(lang === 'tr' ? 'en' : 'tr'), className: "flex items-center gap-2 px-4 py-2 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-full transition-colors font-medium self-center md:self-auto", children: [_jsx(Languages, { size: 20 }), _jsx("span", { children: lang.toUpperCase() })] })] }) }), _jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [_jsx("div", { className: "flex items-center justify-between mb-8 overflow-x-auto", children: [
                            ...
                            { num: 5, label: t('step_report'), icon: Download }
                        ].map(({ num, label, icon: Icon }) => (_jsxs("div", { className: "flex items-center", children: [_jsx("button", { onClick: () => records.length > 0 && setStep(num), className: `flex items-center justify-center w-12 h-12 rounded-full ${step >= num ? 'bg-indigo-600 text-white' : 'bg-gray-300 text-gray-600'} transition-colors`, children: step > num ? _jsx(CheckCircle, { size: 24 }) : _jsx(Icon, { size: 20 }) }), _jsx("span", { className: `ml-2 text-sm font-medium ${step >= num ? 'text-indigo-900' : 'text-gray-500'}`, children: label }), num < 5 && _jsx("div", { className: `w-12 h-1 mx-2 ${step > num ? 'bg-indigo-600' : 'bg-gray-300'}` })] }, num))) }), step === 1 && (_jsxs("div", { className: "bg-white rounded-xl shadow-lg p-8", children: [_jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-6", children: t('upload_title') }), _jsxs("div", { className: "mb-4 flex items-center", children: [_jsx("input", { type: "checkbox", id: "intibak", checked: showIntibak, onChange: (e) => setShowIntibak(e.target.checked), className: "w-4 h-4 text-indigo-600 rounded" }), _jsx("label", { htmlFor: "intibak", className: "ml-2 text-sm text-gray-700", children: t('upload_intibak_checkbox') })] }), _jsxs("div", { className: "border-2 border-dashed border-gray-300 rounded-lg p-12 text-center", children: [_jsx(Upload, { className: "mx-auto h-12 w-12 text-gray-400 mb-4" }), _jsx("span", { className: "mt-2 block text-sm font-medium text-gray-900", children: t('upload_box_text') }), _jsx("input", { id: "transcriptFile", type: "file", accept: ".txt,.pdf", onChange: handleFileUpload, className: "hidden" }), _jsx("label", { htmlFor: "transcriptFile", className: "mt-4 inline-flex items-center justify-center px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 cursor-pointer select-none", children: t('upload_button') })] }), _jsx("div", { className: "mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4", children: _jsxs("div", { className: "flex items-start", children: [_jsx(Info, { className: "h-5 w-5 text-blue-600 mt-0.5 mr-3" }), _jsxs("div", { className: "text-sm text-blue-800", children: [_jsx("p", { className: "font-medium mb-2", children: t('upload_info_title') }), _jsxs("ul", { className: "list-disc list-inside space-y-1", children: [_jsx("li", { children: t('upload_info_1') }), _jsx("li", { children: t('upload_info_2') }), _jsx("li", { children: t('upload_info_3') }), _jsx("li", { children: t('upload_info_4') }), _jsx("li", { children: t('upload_info_5') })] })] })] }) })] })), step === 2 && !gpa && records.length > 0 && (_jsx("div", { className: "flex items-center justify-center min-h-[400px]", children: _jsxs("div", { className: "text-center", children: [_jsx("div", { className: "animate-spin rounded-full h-12 w-12 border-b-2 border-indigo-600 mx-auto mb-4" }), _jsx("p", { className: "text-gray-600", children: t('calculating') })] }) })), step === 2 && gpa && (_jsxs("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500", children: [_jsxs("div", { className: "flex items-center justify-between mb-6", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "p-3 bg-gradient-to-br from-indigo-100 to-violet-100 rounded-xl shadow-sm", children: _jsx(BarChart3, { className: "w-8 h-8 text-indigo-600" }) }), _jsxs("div", { children: [_jsx("h2", { className: "text-2xl font-bold text-gray-800", children: t('gpa_title') }), _jsx("p", { className: "text-gray-500", children: t('gpa_subtitle') })] })] }), _jsxs("button", { onClick: () => {
                                        ...
                                        }, className: "flex items-center gap-2 px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors shadow-sm", children: [_jsx(Download, { size: 18 }), _jsx("span", { children: t('download_report') })] })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [_jsxs("div", { className: `p-6 rounded-2xl shadow-lg transform hover:scale-[1.02] transition-all duration-300 ${gpa.gno >= 3.0 ? 'bg-gradient-to-br from-violet-600 to-indigo-600 text-white' : gpa.gno >= 2.0 ? 'bg-gradient-to-br from-blue-500 to-cyan-500 text-white' : 'bg-gradient-to-br from-orange-500 to-red-500 text-white'}`, children: [_jsx("div", { className: "text-white/80 text-sm font-medium mb-1", children: t('gno_label') }), _jsx("div", { className: "text-5xl font-bold tracking-tight", children: gpa.gno.toFixed(2) }), _jsxs("div", { className: "mt-4 flex items-center gap-2 text-white/90 bg-white/10 p-2 rounded-lg backdrop-blur-sm", children: [gpa.gno >= 2.0 ? _jsx(CheckCircle2, { className: "w-5 h-5" }) : _jsx(AlertCircle, { className: "w-5 h-5" }), _jsx("span", { className: "font-medium", children: t(gpa.gno >= 2.0 ? 'status_success' : 'status_fail') })] })] }), _jsxs("div", { className: "p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow", children: [_jsx("div", { className: "text-gray-500 text-sm font-medium mb-1", children: t('total_ects') }), _jsx("div", { className: "text-4xl font-bold text-gray-800 tracking-tight", children: gpa.totalECTS }), _jsx("div", { className: "mt-4 w-full bg-gray-100 rounded-full h-2 overflow-hidden", children: _jsx("div", { className: "bg-emerald-500 h-2 rounded-full transition-all duration-1000", style: { width: `${Math.min((gpa.totalECTS / 240) * 100, 100)}%` } }) }), _jsx("div", { className: "mt-2 text-xs text-gray-400 font-medium", children: t('graduation_goal') })] }), _jsxs("div", { className: "p-6 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow", children: [_jsx("div", { className: "text-gray-500 text-sm font-medium mb-1", children: t('passed_credits') }), _jsxs("div", { className: "text-4xl font-bold text-gray-800 tracking-tight flex items-baseline gap-2", children: [gpa.passedCredits, _jsxs("span", { className: "text-xl text-gray-400 font-normal", children: ["/", gpa.totalAttempted] })] }), _jsxs("div", { className: "mt-4 text-sm font-medium text-blue-600 bg-blue-50 py-1 px-3 rounded-full w-fit", children: ["%", gpa.totalAttempted > 0 ? Math.min(100, Math.round((gpa.passedCredits / gpa.totalAttempted) * 100)) : 0, " ", t('success_rate_suffix')] })] })] }), eem413Check && (_jsxs("div", { className: "bg-white rounded-xl shadow-lg p-8", children: [_jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-6", children: t('eem413_title') }), eem413Check.eligible ? (_jsxs("div", { className: "flex items-center p-4 bg-green-50 border border-green-200 rounded-lg", children: [_jsx(CheckCircle, { className: "h-6 w-6 text-green-600 mr-3" }), _jsxs("div", { children: [_jsx("p", { className: "font-medium text-green-900", children: t('eem413_success_msg') }), _jsx("p", { className: "text-sm text-green-700 mt-1", children: t('eem413_success_detail') })] })] })) : (_jsx("div", { className: "p-4 bg-red-50 border border-red-200 rounded-lg", children: _jsxs("div", { className: "flex items-start", children: [_jsx(AlertCircle, { className: "h-6 w-6 text-red-600 mr-3 mt-0.5" }), _jsxs("div", { children: [_jsx("p", { className: "font-medium text-red-900 mb-2", children: t('eem413_fail_msg') }), _jsx("ul", { className: "text-sm text-red-700 space-y-1", children: eem413Check.reasons.map((reason, i) => (_jsxs("li", { children: ["\u2022 ", reason] }, i))) })] })] }) }))] })), _jsxs("div", { className: "bg-white rounded-xl shadow-lg p-8", children: [_jsxs("h2", { className: "text-2xl font-bold text-gray-900 mb-6", children: [t('course_list_title'), " (", gpa.usedCourses.length, ")"] }), _jsx("div", { className: "overflow-x-auto", children: _jsxs("table", { className: "min-w-full divide-y divide-gray-200", children: [_jsx("thead", { className: "bg-gray-50", children: _jsxs("tr", { children: [_jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase", children: t('col_code') }), _jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase", children: t('col_name') }), _jsx("th", { className: "px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase", children: t('col_term') }), _jsx("th", { className: "px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase", children: t('col_grade') }), _jsx("th", { className: "px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase", children: t('col_ects') })] }) }), _jsx("tbody", { className: "bg-white divide-y divide-gray-200", children: (showAllRecords ? gpa.usedCourses : gpa.usedCourses.slice(0, 15)).map((record) => (_jsxs("tr", { className: "hover:bg-gray-50", children: [_jsx("td", { className: "px-4 py-3 text-sm font-medium text-gray-900", children: record.courseCode }), _jsx("td", { className: "px-4 py-3 text-sm text-gray-700", children: record.courseName }), _jsx("td", { className: "px-4 py-3 text-sm text-gray-600", children: record.semester }), _jsx("td", { className: "px-4 py-3 text-center", children: _jsx("span", { className: `inline-flex px-2 py-1 text-xs font-semibold rounded-full ${record.grade.passed
                                                                        ? 'bg-green-100 text-green-800'
                                                                        : 'bg-red-100 text-red-800'}`, children: record.grade.letter }) }), _jsx("td", { className: "px-4 py-3 text-sm text-center text-gray-700", children: record.ects })] }, record.id))) })] }) }), gpa.replacedCourses && gpa.replacedCourses.length > 0 && (_jsxs("div", { className: "bg-slate-50 px-4 py-4 mt-4 border border-slate-200 rounded-lg text-xs text-slate-500", children: [_jsxs("div", { className: "font-medium mb-2 flex items-center gap-1 text-slate-700", children: [_jsx(Info, { className: "w-4 h-4" }), "Bu dersler yerine say\u0131ld\u0131\u011F\u0131 i\u00E7in ortalamaya kat\u0131lmam\u0131\u015Ft\u0131r:"] }), _jsx("ul", { className: "grid grid-cols-1 md:grid-cols-2 gap-2", children: gpa.replacedCourses.map(rc => (_jsxs("li", { className: "flex items-center gap-2 bg-white p-2 rounded border border-gray-100", children: [_jsx("span", { className: "font-bold text-gray-700", children: rc.courseCode }), _jsx("span", { className: "text-gray-400", children: "|" }), _jsx("span", { className: "bg-red-50 text-red-700 px-1.5 py-0.5 rounded text-[10px] font-bold", children: rc.grade.letter }), _jsx("span", { className: "text-gray-400", children: "\u2192" }), _jsx("span", { className: "text-gray-600 truncate max-w-[150px]", title: rc.courseName, children: rc.courseName }), _jsx("span", { className: "text-gray-400 text-[10px] ml-auto", children: rc.equivalentCourse ? `(Yerine: ${rc.equivalentCourse})` : '' })] }, rc.id))) })] })), gpa.usedCourses.length > 15 && (_jsx("div", { className: "mt-4 text-center", children: _jsx("button", { onClick: () => setShowAllRecords(!showAllRecords), className: "px-6 py-2 text-sm font-medium text-indigo-600 bg-indigo-50 rounded-lg hover:bg-indigo-100 transition-colors", children: showAllRecords ? (_jsx(_Fragment, { children: t('show_less') })) : (_jsxs(_Fragment, { children: [t('show_more'), " (", gpa.usedCourses.length - 15, " ", t('show_more_suffix')] })) }) }))] }), _jsxs("div", { id: "simulation-section", className: "mt-12 pt-8 border-t border-gray-200", children: [_jsx("div", { className: "flex items-center justify-between mb-6", children: _jsxs("div", { children: [_jsx("h2", { className: "text-2xl font-bold text-gray-800", children: t('sim_title') }), _jsx("p", { className: "text-gray-500", children: t('sim_desc') })] }) }), simGpaResult && (_jsx("div", { className: "space-y-6", children: _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-6", children: [_jsxs("div", { className: "p-6 bg-white rounded-2xl shadow-sm border border-gray-200", children: [_jsx("div", { className: "text-sm text-gray-500 mb-1", children: t('current_gno') }), _jsx("div", { className: "text-3xl font-bold text-gray-400", children: (gpa?.gno || 0).toFixed(2) })] }), _jsxs("div", { className: `p-6 rounded-2xl shadow-lg transform transition-all ${simGpaResult.gno >= (gpa?.gno || 0) ? 'bg-gradient-to-br from-indigo-600 to-purple-600 text-white' : 'bg-gradient-to-br from-orange-500 to-red-500 text-white'}`, children: [_jsx("div", { className: "text-white/80 text-sm font-medium mb-1", children: t('sim_gno') }), _jsxs("div", { className: "flex items-end gap-3", children: [_jsx("div", { className: "text-5xl font-bold tracking-tight", children: simGpaResult.gno.toFixed(2) }), _jsxs("div", { className: `text-lg font-medium px-2 py-1 rounded-lg ${simGpaResult.gno >= (gpa?.gno || 0) ? 'bg-white/20 text-white' : 'bg-black/20 text-white'}`, children: [simGpaResult.gno >= (gpa?.gno || 0) ? '+' : '', (simGpaResult.gno - (gpa?.gno || 0)).toFixed(2)] })] })] }), (() => {
                                                    const simCheck = checkEEM413Eligibility(simulationRecords, simGpaResult, t);
                                                    return (_jsxs("div", { className: `p-6 rounded-2xl shadow-sm border ${simCheck.eligible ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'}`, children: [_jsx("div", { className: `text-sm font-medium mb-1 ${simCheck.eligible ? 'text-green-600' : 'text-red-600'}`, children: t('graduation_cap_title') }), _jsx("div", { className: `text-xl font-bold ${simCheck.eligible ? 'text-green-800' : 'text-red-800'}`, children: t(simCheck.eligible ? 'can_take' : 'cannot_take') })] }));
                                                })(), _jsxs("div", { className: "p-6 bg-white rounded-2xl shadow-sm border border-gray-200", children: [_jsx("div", { className: "text-sm text-gray-500 mb-1", children: t('ects_grad') }), _jsxs("div", { className: "flex flex-col", children: [_jsxs("div", { className: "text-2xl font-bold text-gray-800", children: [simGpaResult.totalECTS.toFixed(1), _jsx("span", { className: "text-sm text-gray-400 font-normal ml-1", children: "/ 240" })] }), _jsx("div", { className: `text-xs mt-1 font-medium ${simGpaResult.totalECTS >= 240 ? 'text-green-600' : 'text-orange-600'}`, children: simGpaResult.totalECTS >= 240
                                                                        ? t('credits_completed')
                                                                        : `${t('credits_remaining')} ${(240 - simGpaResult.totalECTS).toFixed(1)} ${t('credits_remaining_suffix')}` })] })] })] }) })), _jsxs("div", { className: "bg-white rounded-xl shadow-lg p-6 border border-gray-100 mt-6", children: [_jsx("h3", { className: "font-bold text-lg text-gray-800 mb-4", children: t('add_course_title') }), _jsxs("div", { className: "flex gap-6 border-b border-gray-200 mb-6", children: [_jsx("button", { className: `pb-2 px-1 font-medium text-sm transition-colors ${!isCustomMode ? 'border-b-2 border-indigo-600 text-indigo-600' : 'text-gray-500 hover:text-gray-700'}`, onClick: () => setIsCustomMode(false), children: t('tab_list') }), _jsx("button", { className: `pb-2 px-1 font-medium text-sm transition-colors ${isCustomMode ? 'border-b-2 border-indigo-600 text-indigo-600' : 'text-gray-500 hover:text-gray-700'}`, onClick: () => setIsCustomMode(true), children: t('tab_custom') })] }), !isCustomMode ? (_jsxs("div", { className: "flex flex-col md:flex-row gap-4 items-end", children: [_jsxs("div", { className: "flex-1 w-full relative", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: t('tab_list') }), isSearchOpen && (_jsx("div", { className: "fixed inset-0 z-10 cursor-default", onClick: () => setIsSearchOpen(false) })), _jsxs("div", { className: "relative z-20", children: [_jsx("input", { className: "w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500", value: simAddCourseCode, onChange: (e) => {
                                                                            setSimAddCourseCode(e.target.value);
                                                                            setIsSearchOpen(true);
                                                                        }, onFocus: () => setIsSearchOpen(true), placeholder: t('search_placeholder') }), isSearchOpen && (_jsx("ul", { className: "absolute w-full mt-1 bg-white border border-gray-200 rounded-lg shadow-xl max-h-60 overflow-y-auto divide-y divide-gray-100", children: (() => {
                                                                        ...
                                                                        })() }))] })] }), _jsxs("div", { className: "w-full md:w-32", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: t('target_grade') }), _jsx("select", { className: "w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500", value: simAddGrade, onChange: (e) => setSimAddGrade(e.target.value), children: ['AA', 'AB', 'BA', 'BB', 'BC', 'CB', 'CC', 'CD', 'DC', 'DD', 'FF', 'YT'].map(g => (_jsx("option", { value: g, children: g }, g))) })] }), _jsx("button", { onClick: () => {
                                                            if (simAddCourseCode) {
                                                                addSimulationCourse(simAddCourseCode, simAddGrade);
                                                                setSimAddCourseCode(''); // Reset
                                                            }
                                                        }, disabled: !simAddCourseCode, className: "w-full md:w-auto px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:opacity-50 font-medium", children: t('btn_add') })] })) : (_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-12 gap-4 items-end", children: [_jsxs("div", { className: "md:col-span-3", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: t('input_code') }), _jsx("input", { className: "w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500 uppercase", value: customCourse.code, onChange: e => setCustomCourse(prev => ({ ...prev, code: e.target.value })), placeholder: "\u00D6rn: YENI101" })] }), _jsxs("div", { className: "md:col-span-12 lg:col-span-5", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: t('input_name') }), _jsx("input", { className: "w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500", value: customCourse.name, onChange: e => setCustomCourse(prev => ({ ...prev, name: e.target.value })), placeholder: "\u00D6rn: \u0130leri Yapay Zeka" })] }), _jsxs("div", { className: "md:col-span-2", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: t('input_credit') }), _jsx("input", { type: "number", className: "w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500", value: customCourse.credits, onChange: e => setCustomCourse(prev => ({ ...prev, credits: Number(e.target.value) })) })] }), _jsxs("div", { className: "md:col-span-2", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: "AKTS" }), _jsx("input", { type: "number", className: "w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500", value: customCourse.ects, onChange: e => setCustomCourse(prev => ({ ...prev, ects: Number(e.target.value) })) })] }), _jsxs("div", { className: "md:col-span-4", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: t('input_type') }), _jsxs("select", { className: "w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500", value: customCourse.type, onChange: e => setCustomCourse(prev => ({ ...prev, type: e.target.value })), children: [_jsx("option", { value: "secmeli", children: t('type_elective') }), _jsx("option", { value: "mesleki_secmeli", children: t('type_technical') }), _jsx("option", { value: "zorunlu", children: t('type_mandatory') })] })] }), _jsxs("div", { className: "md:col-span-3", children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: t('col_grade') }), _jsx("select", { className: "w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-indigo-500", value: customCourse.grade, onChange: e => setCustomCourse(prev => ({ ...prev, grade: e.target.value })), children: ['AA', 'AB', 'BA', 'BB', 'BC', 'CB', 'CC', 'CD', 'DC', 'DD', 'FF', 'YT'].map(g => (_jsx("option", { value: g, children: g }, g))) })] }), _jsx("div", { className: "md:col-span-5 flex justify-end", children: _jsx("button", { onClick: addCustomSimulationCourse, disabled: !customCourse.code || !customCourse.name, className: "w-full md:w-auto px-8 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 disabled:opacity-50 font-medium", children: t('btn_custom_add') }) })] }))] }), _jsxs("div", { className: "bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden mt-6", children: [_jsxs("div", { className: "p-6 border-b border-gray-100 bg-gray-50 flex justify-between items-center", children: [_jsx("h3", { className: "font-bold text-gray-800", children: t('sim_table_title') }), _jsxs("span", { className: "text-sm text-gray-500", children: [simGpaResult?.usedCourses?.length || 0, " ", t('col_name')] })] }), _jsx("div", { className: "overflow-x-auto max-h-[600px]", children: _jsxs("table", { className: "w-full text-sm text-left", children: [_jsx("thead", { className: "text-xs text-gray-500 uppercase bg-gray-50 sticky top-0", children: _jsxs("tr", { children: [_jsx("th", { className: "px-6 py-3", children: t('col_code') }), _jsx("th", { className: "px-6 py-3", children: t('col_name') }), _jsx("th", { className: "px-6 py-3 text-center", children: t('input_credit') }), _jsx("th", { className: "px-6 py-3 text-center", children: t('col_term') }), _jsx("th", { className: "px-6 py-3 text-center", children: t('col_sim_grade') }), _jsx("th", { className: "px-6 py-3 text-center", children: t('col_action') })] }) }), _jsx("tbody", { className: "divide-y divide-gray-100", children: simGpaResult?.usedCourses?.map((record) => (_jsxs("tr", { className: `hover:bg-gray-50 transition-colors ${record.semester === 'Simülasyon' ? 'bg-indigo-50/30' : ''}`, children: [_jsx("td", { className: "px-6 py-4 font-medium text-gray-900", children: record.courseCode }), _jsx("td", { className: "px-6 py-4 text-gray-600 max-w-xs truncate", title: record.courseName || '', children: record.courseName }), _jsx("td", { className: "px-6 py-4 text-center font-medium", children: record.credits }), _jsx("td", { className: "px-6 py-4 text-center text-xs text-gray-500", children: record.semester }), _jsx("td", { className: "px-6 py-4 text-center", children: _jsx("select", { className: `px-3 py-1 rounded-full text-xs font-bold border-0 cursor-pointer focus:ring-2 focus:ring-indigo-500 ${record.grade.passed ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`, value: record.grade.letter, onChange: (e) => updateSimulationGrade(record.id, e.target.value), children: ['AA', 'AB', 'BA', 'BB', 'BC', 'CB', 'CC', 'CD', 'DC', 'DD', 'FF', 'YT'].map(g => (_jsx("option", { value: g, children: g }, g))) }) }), _jsx("td", { className: "px-6 py-4 text-center", children: record.semester === 'Simülasyon' && (_jsx("button", { onClick: () => removeSimulationRecord(record.id), className: "text-red-500 hover:text-red-700 p-1 rounded-full hover:bg-red-50", title: "Dersi Sil", children: _jsx(Trash2, { className: "w-4 h-4" }) })) })] }, record.id))) })] }) })] }), _jsxs("div", { className: "flex justify-between mt-8", children: [_jsx("button", { onClick: () => setStep(1), className: "px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50", children: "\u2190 Geri" }), _jsx("button", { onClick: () => setStep(3), className: "px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700", children: "Uzmanla\u015Fma Analizi \u2192" })] })] })] })), step === 3 && (_jsxs("div", { className: "space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500", children: [_jsxs("div", { className: "bg-white rounded-xl shadow-lg p-8 border border-indigo-100", children: [_jsxs("h2", { className: "text-2xl font-bold text-gray-900 mb-4 flex items-center gap-2", children: [_jsx(Award, { className: "text-indigo-600" }), t('spec_title'), " ", _jsxs("span", { className: "text-sm font-normal text-gray-500 ml-2", children: [t('spec_subtitle_prefix'), analyzeSpecializations(records).activeSeason, " ", t('spec_subtitle_suffix')] })] }), (() => {
                                        const analysis = analyzeSpecializations(records);
                                        const isTotalMet = analysis.totalTechnicalElectives >= 7;
                                        return (_jsxs("div", { children: [_jsxs("div", { className: "flex flex-col md:flex-row gap-6 mb-8", children: [_jsxs("div", { className: `flex-1 p-4 rounded-xl border-l-4 ${isTotalMet ? 'bg-green-50 border-green-500' : 'bg-amber-50 border-amber-500'} shadow-sm`, children: [_jsx("h3", { className: "font-bold text-gray-800 mb-1", children: t('total_technical') }), _jsxs("div", { className: "flex items-end gap-2", children: [_jsx("span", { className: "text-3xl font-bold", children: analysis.totalTechnicalElectives }), _jsx("span", { className: "text-gray-500 mb-1", children: t('min_7_courses') })] }), _jsx("p", { className: `text-sm mt-2 ${isTotalMet ? 'text-green-700' : 'text-amber-700'}`, children: isTotalMet ? t('min_7_success') : t('min_7_fail') })] }), _jsxs("div", { className: "flex-1 p-4 bg-blue-50 border-l-4 border-blue-500 rounded-xl shadow-sm", children: [_jsx("h3", { className: "font-bold text-gray-800 mb-1", children: t('best_area') }), _jsx("div", { className: "text-xl font-bold text-blue-900", children: analysis.bestGroup
                                                                        ? SPECIALIZATION_GROUPS.find(g => g.id === analysis.bestGroup)?.name
                                                                        : 'Henüz seçim yapılmadı' }), _jsx("p", { className: "text-sm text-blue-700 mt-2", children: t('best_area_desc') })] })] }), _jsx("h3", { className: "text-xl font-bold text-gray-800 mb-4", children: t('area_progress_title') }), _jsx("div", { className: "grid grid-cols-1 xl:grid-cols-2 gap-6", children: analysis.groups.map((groupResult) => (_jsxs("div", { className: `relative overflow-hidden rounded-xl border-2 transition-all duration-300 ${groupResult.isQualified
                                                            ? 'border-green-500 bg-white shadow-md ring-4 ring-green-50/50'
                                                            : 'border-gray-200 bg-white hover:border-indigo-300 hover:shadow-md'}`, children: [groupResult.isQualified && (_jsx("div", { className: "absolute top-0 right-0 bg-green-500 text-white text-xs font-bold px-3 py-1 rounded-bl-lg z-10", children: t('status_completed') })), _jsxs("div", { className: "p-5 border-b border-gray-100 bg-gray-50/50", children: [_jsx("h4", { className: "font-bold text-lg text-gray-900 pr-8", children: groupResult.group.name }), _jsxs("div", { className: "flex items-center gap-4 mt-2", children: [_jsxs("div", { className: "flex items-center text-sm font-medium", children: [_jsx("span", { className: `w-2 h-2 rounded-full mr-2 ${groupResult.takenCount >= 5 ? 'bg-green-500' : 'bg-gray-300'}` }), t('progress_label'), " ", groupResult.takenCount, "/5"] }), _jsxs("div", { className: "flex items-center text-sm font-medium", children: [_jsx("span", { className: `w-2 h-2 rounded-full mr-2 ${groupResult.mandatoryMissing.length === 0 ? 'bg-green-500' : 'bg-red-500'}` }), t('mandatory_label'), " ", groupResult.mandatoryMissing.length === 0 ? t('mandatory_ok') : `${groupResult.mandatoryMissing.length} ${t('mandatory_missing')}`] })] }), _jsx("div", { className: "mt-3 w-full bg-gray-200 rounded-full h-1.5 overflow-hidden", children: _jsx("div", { className: `h-full rounded-full ${groupResult.isQualified ? 'bg-green-500' : 'bg-indigo-500'}`, style: { width: `${Math.min((groupResult.takenCount / 5) * 100, 100)}%` } }) })] }), _jsx("div", { className: "p-0", children: _jsx("div", { className: "max-h-60 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-200 p-2", children: _jsxs("table", { className: "w-full text-sm", children: [_jsx("thead", { className: "text-xs text-gray-400 bg-gray-50 sticky top-0", children: _jsxs("tr", { children: [_jsx("th", { className: "text-left py-2 px-3 font-medium", children: t('col_code') }), _jsx("th", { className: "text-left py-2 px-3 font-medium", children: t('col_name') }), _jsx("th", { className: "text-center py-2 px-3 font-medium", children: "Durum" })] }) }), _jsx("tbody", { className: "divide-y divide-gray-50", children: groupResult.coursesStatus.map((statusItem, idx) => (_jsxs("tr", { className: "group hover:bg-gray-50", children: [_jsxs("td", { className: "py-2 px-3 font-mono text-xs text-gray-600", children: [statusItem.course.code, statusItem.course.isMandatory && _jsx("span", { className: "ml-1 text-red-500 font-bold", title: "Zorunlu", children: "(Z)" })] }), _jsxs("td", { className: "py-2 px-3 text-gray-700 truncate max-w-[180px]", title: statusItem.course.name, children: [statusItem.course.name, _jsx("div", { className: "text-[10px] text-gray-400", children: statusItem.course.term })] }), _jsxs("td", { className: "py-2 px-3 text-center", children: [statusItem.status === 'taken' && (_jsxs("span", { className: "inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-green-100 text-green-800", children: [_jsx(CheckCircle, { size: 12, className: "mr-1" }), " ", t('status_taken')] })), statusItem.status === 'available' && (_jsx("span", { className: "inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-blue-50 text-blue-700 border border-blue-100", children: t('status_available') })), statusItem.status === 'locked' && (_jsxs("span", { className: "inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-100 text-gray-500", title: `Önşart: ${statusItem.missingPrereq}`, children: ["\uD83D\uDD12 ", statusItem.missingPrereq] })), statusItem.status === 'wrong_term' && (_jsxs("span", { className: "inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-gray-50 text-gray-400 border border-gray-100 italic", children: ["\u23F3 ", statusItem.course.term, " D\u00F6nemi"] }))] })] }, idx))) })] }) }) })] }, groupResult.group.id))) }), _jsxs("div", { className: "mt-8 bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-sm text-yellow-800", children: [_jsxs("h4", { className: "font-bold flex items-center gap-2 mb-2", children: [_jsx(Info, { size: 16 }), " ", t('rules_reminder')] }), _jsxs("ul", { className: "list-disc list-inside space-y-1 ml-1", children: [_jsx("li", { children: t('rule_1') }), _jsx("li", { children: t('rule_2') }), _jsx("li", { children: t('rule_3') }), _jsx("li", { children: t('rule_4') })] })] })] }));
                                    })()] }), _jsxs("div", { className: "flex justify-between", children: [_jsx("button", { onClick: () => setStep(2), className: "px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50", children: t('btn_back') }), _jsx("button", { onClick: () => setStep(4), className: "px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700", children: t('btn_next_schedule') })] })] })), step === 4 && (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "bg-white rounded-xl shadow-lg p-8", children: [_jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-2", children: t('schedule_title') }), _jsx("p", { className: "text-gray-600 mb-6", children: t('schedule_desc') }), _jsxs("div", { className: "flex gap-4 border-b border-gray-200 mb-6", children: [_jsx("button", { onClick: () => setActiveScheduleTab('manual'), className: `pb-3 px-4 font-medium transition-colors ${activeScheduleTab === 'manual'
                                                    ? 'border-b-2 border-indigo-600 text-indigo-600'
                                                    : 'text-gray-500 hover:text-gray-700'}`, children: t('tab_manual') }), _jsx("button", { onClick: () => setActiveScheduleTab('pdf'), className: `pb-3 px-4 font-medium transition-colors ${activeScheduleTab === 'pdf'
                                                    ? 'border-b-2 border-indigo-600 text-indigo-600'
                                                    : 'text-gray-500 hover:text-gray-700'}`, children: t('tab_pdf') })] }), activeScheduleTab === 'manual' && (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: t('input_code') }), _jsx("input", { type: "text", placeholder: "EEM321", value: manualCourse.courseCode, onChange: (e) => setManualCourse({ ...manualCourse, courseCode: e.target.value.toUpperCase() }), className: "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: t('input_day') }), _jsxs("select", { value: manualCourse.day, onChange: (e) => setManualCourse({ ...manualCourse, day: e.target.value }), className: "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500", children: [_jsx("option", { value: "", children: "Se\u00E7" }), _jsx("option", { value: "Pazartesi", children: "Pazartesi" }), _jsx("option", { value: "Sal\u0131", children: "Sal\u0131" }), _jsx("option", { value: "\u00C7ar\u015Famba", children: "\u00C7ar\u015Famba" }), _jsx("option", { value: "Per\u015Fembe", children: "Per\u015Fembe" }), _jsx("option", { value: "Cuma", children: "Cuma" }), _jsx("option", { value: "Cumartesi", children: "Cumartesi" })] })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: t('input_start') }), _jsx("input", { type: "time", value: manualCourse.startTime, onChange: (e) => setManualCourse({ ...manualCourse, startTime: e.target.value }), className: "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500" })] }), _jsxs("div", { children: [_jsx("label", { className: "block text-sm font-medium text-gray-700 mb-1", children: t('input_end') }), _jsx("input", { type: "time", value: manualCourse.endTime, onChange: (e) => setManualCourse({ ...manualCourse, endTime: e.target.value }), className: "w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500" })] })] }), _jsx("button", { onClick: () => {
                                                ...
                                                }, disabled: !manualCourse.courseCode || !manualCourse.day || !manualCourse.startTime || !manualCourse.endTime, className: "px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed", children: t('btn_add_lesson') })] })), activeScheduleTab === 'pdf' && (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "border-2 border-dashed border-gray-300 rounded-lg p-8 text-center", children: [_jsx("input", { type: "file", accept: ".pdf", onChange: handleSchedulePdfUpload, className: "hidden", id: "schedule-pdf-input" }), _jsx("label", { htmlFor: "schedule-pdf-input", className: "cursor-pointer", children: _jsxs("div", { className: "text-gray-600", children: [_jsx("svg", { className: "mx-auto h-12 w-12 text-gray-400", stroke: "currentColor", fill: "none", viewBox: "0 0 48 48", children: _jsx("path", { d: "M28 8H12a4 4 0 00-4 4v20m32-12v8m0 0v8a4 4 0 01-4 4H12a4 4 0 01-4-4v-4m32-4l-3.172-3.172a4 4 0 00-5.656 0L28 28M8 32l9.172-9.172a4 4 0 015.656 0L28 28m0 0l4 4m4-24h8m-4-4v8m-12 4h.02", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }), _jsx("p", { className: "mt-2 text-sm font-medium", children: t('pdf_upload_text') }), _jsx("p", { className: "mt-1 text-xs text-gray-500", children: t('pdf_upload_sub') })] }) })] }), _jsx("p", { className: "text-xs text-gray-500", children: t('pdf_hint') })] })), departmentSchedule.length > 0 && (_jsxs("div", { className: "mt-8 p-6 bg-indigo-50 rounded-xl border border-indigo-100", children: [_jsxs("div", { className: "flex justify-between items-center mb-4", children: [_jsx("h3", { className: "text-lg font-bold text-indigo-900", children: t('dept_schedule_title') }), _jsxs("button", { onClick: autoAddFailedCourses, className: "px-4 py-2 bg-red-600 text-white text-sm rounded-lg hover:bg-red-700 flex items-center gap-2", children: [_jsx(AlertCircle, { size: 16 }), t('btn_auto_add_failed')] })] }), _jsx("p", { className: "text-sm text-indigo-700 mb-4", children: t('dept_schedule_desc') }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-h-[500px] overflow-y-auto", children: Array.from(new Set(departmentSchedule.map(s => s.courseCode))).sort().map(code => {
                                                    ...
                                                    return (_jsxs("div", { className: "bg-white p-4 rounded-lg shadow-sm border border-indigo-100", children: [_jsxs("div", { className: "flex justify-between items-center mb-3 pb-2 border-b border-gray-100", children: [_jsx("div", { className: "font-bold text-gray-800 text-lg", children: code }), _jsxs("div", { className: "flex gap-1", children: [lectures.length > 0 && (_jsxs("span", { className: "text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded", children: [lectures.length, " Teorik"] })), labs.length > 0 && (_jsxs("span", { className: "text-xs bg-orange-100 text-orange-700 px-2 py-1 rounded", children: [labs.length, " Lab"] }))] })] }), lectures.length > 0 && (_jsxs("div", { className: "mb-3", children: [_jsxs("div", { className: "flex justify-between items-center mb-2", children: [_jsxs("div", { className: "text-xs font-semibold text-blue-700 flex items-center gap-1", children: ["\uD83D\uDCD6 ", t('col_name')] }), _jsxs("button", { onClick: () => {
                                                                ...
                                                                return (_jsxs("div", { children: [_jsxs("div", { className: "text-xs font-semibold text-orange-700 mb-2 flex items-center gap-1", children: ["\uD83D\uDD2C ", t('lab_groups'), selectedLabSection && (_jsxs("span", { className: "ml-2 px-2 py-0.5 bg-green-100 text-green-700 rounded", children: ["\u2713 ", t('group_selected'), " ", selectedLabSection] }))] }), _jsx("div", { className: "space-y-2", children: Array.from(new Set(labs.map(l => l.section))).sort().map(section => {
                                                                                ...
                                                                                return (_jsxs("div", { className: `p-2 rounded border ${isThisGroupSelected
                                                                                        ...
                                                                                        : isOtherGroupSelected
                                                                                            ...
                                                                                            : 'bg-orange-50 border-orange-100'}`, children: [_jsxs("div", { className: "flex justify-between items-center mb-1", children: [_jsxs("span", { className: `text-xs font-bold ${isThisGroupSelected ? 'text-green-800' : 'text-orange-800'}`, children: ["Grup ", section] }), isThisGroupSelected ? (_jsx("button", { onClick: () => {
                                                                                                    ...
                                                                                                    }, className: "text-xs bg-red-500 text-white px-2 py-0.5 rounded hover:bg-red-600", children: t('btn_remove') })) : (_jsx("button", { onClick: () => {
                                                                    ...
                                                                    })] }, timeSlot))) })] }) }), _jsxs("div", { className: "mt-6", children: [_jsx("h3", { className: "font-semibold text-gray-900 mb-3", children: t('conflict_analysis') }), (() => {
                                                        const conflicts = detectScheduleConflicts(selectedSchedule);
                                                        return conflicts.length > 0 ? (_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: conflicts.map((c, i) => (_jsxs("div", { className: "p-3 bg-red-50 border border-red-200 rounded-lg flex items-start", children: [_jsx(AlertCircle, { className: "text-red-500 mt-0.5 mr-2 shrink-0", size: 18 }), _jsxs("div", { children: [_jsx("div", { className: "font-bold text-red-900 text-sm", children: t('conflict_detected') }), _jsx("div", { className: "text-red-700 text-sm mt-1", children: c.courses.join(' ve ') }), _jsx("div", { className: "text-red-600 text-xs mt-0.5", children: c.time })] })] }, i))) })) : (_jsx("div", { className: "p-4 bg-green-50 border border-green-200 rounded-lg", children: _jsxs("p", { className: "text-sm text-green-800 flex items-center", children: [_jsx(CheckCircle, { className: "mr-2", size: 16 }), t('no_conflict')] }) }));
                                                    })()] })] }))] }), _jsxs("div", { className: "flex justify-between items-center", children: [_jsx("button", { onClick: () => setStep(3), className: "px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50", children: t('btn_back') }), _jsxs("div", { className: "flex gap-3", children: [_jsx("button", { onClick: () => setStep(5), className: "px-6 py-2 border border-gray-300 text-gray-600 rounded-lg hover:bg-gray-50", children: "Bu Ad\u0131m\u0131 Atla \u2192" }), _jsx("button", { onClick: () => setStep(5), className: "px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700", children: t('btn_next_report') })] })] })] })), step === 5 && gpa && (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "bg-white rounded-xl shadow-lg p-8", children: [_jsx("h2", { className: "text-2xl font-bold text-gray-900 mb-6", children: t('report_title') }), _jsxs("div", { className: "space-y-4 mb-6", children: [_jsxs("div", { className: "p-4 bg-gray-50 rounded-lg", children: [_jsx("h3", { className: "font-semibold mb-2", children: t('report_grade_status') }), _jsxs("p", { children: ["GNO: ", _jsx("strong", { children: gpa.gno.toFixed(2) }), " | AKTS: ", _jsxs("strong", { children: [gpa.totalECTS, "/240"] })] })] }), selectedArea && (_jsxs("div", { className: "p-4 bg-gray-50 rounded-lg", children: [_jsx("h3", { className: "font-semibold mb-2", children: t('report_best_spec') }), _jsx("p", { children: (() => {
                                                            const analysis = analyzeSpecializations(records);
                                                            ...
                                                            if (best) {
                                                                ...
                                                                return (_jsxs(_Fragment, { children: [_jsx("strong", { children: best.name }), _jsxs("p", { className: "text-sm text-gray-600 mt-1", children: [t('progress_label'), " ", groupResult?.takenCount, "/5"] })] }));
                                                            }
                                                            return _jsx("span", { children: "Hen\u00FCz yeterli veri yok" });
                                                        })() })] })), eem413Check && (_jsxs("div", { className: "p-4 bg-gray-50 rounded-lg", children: [_jsx("h3", { className: "font-semibold mb-2", children: t('report_eem413') }), _jsx("p", { className: eem413Check.eligible ? 'text-green-600' : 'text-red-600', children: eem413Check.eligible ? t('can_take') : t('cannot_take') })] }))] }), _jsxs("div", { className: "space-y-4", children: [_jsxs("button", { onClick: () => {
                                                    const passedCodes = new Set(records.filter(r => r.grade.passed).map(r => r.courseCode));
                                                    const simResult = simulationRecords.length > 0 ? calculateGPA(simulationRecords) : null;
                                                    generateAcademicReport({
                                                        studentName: 'Öğrenci',
                                                ...
                                                }, className: "w-full flex items-center justify-center px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors shadow-lg transform hover:scale-[1.02]", children: [_jsx(Download, { size: 24, className: "mr-2" }), _jsx("span", { className: "font-bold text-lg", children: t('report_btn_download') })] }), _jsx("p", { className: "text-center text-sm text-gray-500 mt-4", children: t('report_footer') })] })] }), _jsxs("div", { className: "flex justify-between", children: [_jsx("button", { onClick: () => setStep(4), className: "px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50", children: t('btn_back') }), _jsx("button", { onClick: () => setStep(1), className: "px-6 py-2 border border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50", children: t('btn_new_analysis') })] })] })), _jsx("footer", { className: "bg-white border-t mt-12", children: _jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6", children: [_jsxs("p", { className: "text-center text-gray-600 text-sm font-medium", children: [_jsx("span", { className: "md:hidden", children: t('header_title_mobile') }), _jsx("span", { className: "hidden md:block", children: t('header_title_desktop') })] }), _jsxs("div", { className: "flex flex-col items-center gap-3 mt-4", children: [_jsxs("div", { className: "flex items-center gap-2 text-xs text-emerald-700 bg-emerald-50 px-4 py-2 rounded-full border border-emerald-100 shadow-sm", children: [_jsx(ShieldCheck, { size: 16 }), _jsx("span", { className: "font-medium", children: t('footer_security') })] }), _jsxs("div", { className: "flex items-center gap-3 text-xs text-gray-400", children: [_jsx("span", { children: t('footer_developer') }), _jsx("span", { className: "text-gray-300", children: "|" }), _jsxs("a", { href: "https://github.com/Ahmetfurkanguven/estu-student-assistant", target: "_blank", rel: "noreferrer", className: "flex items-center gap-1 text-indigo-500 hover:text-indigo-700 transition-colors font-medium", children: [_jsx(Github, { size: 14 }), _jsx("span", { children: t('footer_opensource') })] })] })] })] }) }), _jsx(VisitorCounter, {})] })] }));
}
